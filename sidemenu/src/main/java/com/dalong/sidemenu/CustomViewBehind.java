...
public class CustomViewBehind extends ViewGroup {
	...
	protected void dispatchDraw(Canvas canvas) {
		//LogCat.e(LogCat.TAGAN,"CustomViewBehind----dispatchDraw------"+getMenuPage(mViewAbove.getCurrentItem()));
		if (mTransformer != null&&mViewAbove !=null&&mViewAbove.getmScrollX()<=0&&isWidthOffset()) {
			canvas.save();
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		//LogCat.e(LogCat.TAGAN,"onLayout------------>>>");
		final int width = r - l;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		//LogCat.e(LogCat.TAGAN,"onMeasure------------>>>");
	...
	public boolean isWidthOffset() {
		return mIsWidthOffset;
	}

	public void setIsWidthOffset(boolean mIsWidthOffset) {
		this.mIsWidthOffset = mIsWidthOffset;
	}
}
